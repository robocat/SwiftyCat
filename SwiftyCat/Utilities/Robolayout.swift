...
public extension UIView {
    ...
    private func addConstraintsWithFormat(_ format: String, options: NSLayoutFormatOptions = [], views: [String: UIView]) -> [NSLayoutConstraint] {
    ...
    public func setEdgesEqualToSuperview(_ insets: UIEdgeInsets = UIEdgeInsetsZero) -> [NSLayoutConstraint] {
